<x-layout title="TOP | Event">
    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          @endphp
          <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="{{ Storage::disk('dropbox')->url($image->name) }}">
          <div class="text-center lg:w-2/3 w-full">
            ...
            <p class="mb-8 leading-relaxed">{!! nl2br(e($event->description)) !!}</p>
          </div>
        </div>
      </section>
